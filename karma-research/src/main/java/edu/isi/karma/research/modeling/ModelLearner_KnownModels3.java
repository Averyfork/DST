...
//		System.out.println("numberOfAttributesWhoseTypeIsFirstCRFType:" + numberOfAttributesWhoseTypeIsFirstCRFType);
	...
	public static String[] test(int tar) throws Exception {
...
//							resultFile.println(numberOfKnownModels + "\t" + me.getPrecision() + "\t" + me.getRecall());
							...
							oneResult = new String[]{semanticModels.get(newSourceIndex).getName(), String.valueOf(me.getPrecision()), String.valueOf(me.getRecall()), String.valueOf(elapsedTimeSec)};
//							if (iterativeEvaluation) {
...
//		}
	...
	public static void main(String[] args) throws Exception {
		String prresultFileDir = "D:\\Day_day_up\\Web-Karma-master\\vagrant\\karma\\"+Params.DATASET_NAME+"\\results\\"+"\\karma_result.csv";
		String[] headArr = {"TargetDataSource","Precision", "Recall","Time"};
