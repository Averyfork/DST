...
//		System.out.println("numberOfAttributesWhoseTypeIsFirstCRFType:" + numberOfAttributesWhoseTypeIsFirstCRFType);
     ...
     * */
    public static List<SortableSemanticModel> getCandidateSemanticModels(int newSourceIndex,int[] trainDataIndex) throws Exception {
        ...
        List<SemanticModel> semanticModels = ModelReader.importSemanticModelsFromJsonFiles(Params.ROOT_DIR+"models-json-modified", Params.MODEL_MAIN_FILE_EXT);
...
//        for (File f : files) {
//
//            if (f.getName().endsWith(".DS_Store")) {/**filter out ".DS_Store" file in the directory of 'preloaded-ontologies'**/
//                continue;
//            }
