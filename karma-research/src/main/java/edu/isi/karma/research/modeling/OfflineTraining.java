...
//		sm.setMrr(roundDecimals(mrrItem.getMrr(),2));
	...
	public SemanticModel getCorrectModel(ServletContextParameterMap contextParameters, 
		...
		String modelJson = contextParameters.getParameterValue(ContextParameter.JSON_MODELS_DIR) + sm.getName() +  ".model.json";
		String modelGraphviz = contextParameters.getParameterValue(ContextParameter.GRAPHVIZ_MODELS_DIR) + sm.getName() +  ".model.dot";
		String evaluateMRR = contextParameters.getParameterValue(ContextParameter.EVALUATE_MRR) + sm.getName() + ".mrr.json";
