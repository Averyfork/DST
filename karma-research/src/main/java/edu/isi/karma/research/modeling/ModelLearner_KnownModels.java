...
//			System.out.println(source.getName());
	...
	public static void runResearchEvaluation() throws Exception {
		 ...
		 */
		ServletContextParameterMap contextParameters = ContextParametersRegistry.getInstance().registerByKarmaHome("D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator);
		contextParameters.setParameterValue(ContextParameter.USER_DIRECTORY_PATH, "D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator);
		contextParameters.setParameterValue(ContextParameter.USER_CONFIG_DIRECTORY, "D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator+"config"+File.separator);
		contextParameters.setParameterValue(ContextParameter.TRAINING_EXAMPLE_MAX_COUNT, "1000000");
		contextParameters.setParameterValue(ContextParameter.SEMTYPE_MODEL_DIRECTORY, "D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator+"semantic-type-files"+File.separator);
		contextParameters.setParameterValue(ContextParameter.JSON_MODELS_DIR, "D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator+"museum-29-edm"+File.separator+"models-json"+File.separator);
		contextParameters.setParameterValue(ContextParameter.GRAPHVIZ_MODELS_DIR, "D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator+"museum-29-edm"+File.separator+"models-graphviz"+File.separator);
		contextParameters.setParameterValue(ContextParameter.USER_PYTHON_SCRIPTS_DIRECTORY, "D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator+"python"+File.separator);
		contextParameters.setParameterValue(ContextParameter.EVALUATE_MRR, "D:"+File.separator+"Day_day_up"+File.separator+"Web-Karma-master"+File.separator+"vagrant"+File.separator+"karma"+File.separator+"evaluate-mrr"+File.separator);
...
//		String filePath = Params.RESULTS_DIR + "temp"+File.separator;
//		String filename = "";
//		filename += "results";
...
//		int i = 1; {
			...
			logger.info("======================================================");
			logger.info(newSource.getName() + "(#attribu .attributes:" + newSource.getColumnNodes().size() + ")");
			logger.info("======================================================");
...
//		}
	...
	public static void runUkHackEvaluation() throws Exception {
		...
		String karmaHomeDir = "D:/Day_day_up/Web-Karma-master/vagrant/karma/";
		...
		String ukHacKDirStr = karmaHomeDir + "museum-edu/";
